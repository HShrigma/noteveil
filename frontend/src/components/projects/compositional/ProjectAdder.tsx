            ...
            {isActive ? (
                <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2 mt-2">
                        ...
                        <button
                            onClick={submit}
                            className="p-2 rounded-full border-2 border-green-500 text-green-500 bg-transparent 
                         hover:bg-[#9ece6a] hover:text-[#f6faff] hover:shadow-[0_0_10px_#9ece6a] transition-all duration-150 cursor-pointer"
                        >
